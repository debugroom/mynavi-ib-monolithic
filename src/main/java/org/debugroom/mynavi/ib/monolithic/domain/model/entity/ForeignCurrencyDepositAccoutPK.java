...
public class ForeignCurrencyDepositAccoutPK implements Serializable {
    ...
    @Column(name = "foreign_currency_account_no", insertable = false, updatable = false,  nullable = false, length = 7)
    @Id
    ...
    public boolean equals(Object o) {
        ...
        ForeignCurrencyDepositAccoutPK that = (ForeignCurrencyDepositAccoutPK) o;
