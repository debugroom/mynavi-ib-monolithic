...
@Entity
@Table(name = "foreign_currency_deposit_accout", schema = "public", catalog = "mynavi_ib")
@IdClass(ForeignCurrencyDepositAccoutPK.class)
public class ForeignCurrencyDepositAccout {
    ...
    public boolean equals(Object o) {
        ...
        ForeignCurrencyDepositAccout that = (ForeignCurrencyDepositAccout) o;
    ...
    @OneToMany(mappedBy = "foreignCurrencyDepositAccout")
