...
public class ForeignCurrencyDepositPK implements Serializable {
    ...
    @Column(name = "foreign_currency_account_no", nullable = false, insertable = false, updatable = false, length = 7)
    @Id
    ...
    public boolean equals(Object o) {
        ...
        ForeignCurrencyDepositPK that = (ForeignCurrencyDepositPK) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(tradeId, userId, financialCode, branchId, accountNo, foreignCurrencyAccountNo);
    }
}
