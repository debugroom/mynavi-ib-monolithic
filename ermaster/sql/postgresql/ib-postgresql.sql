...
DROP TABLE IF EXISTS FOREIGN_CURRENCY_DEPOSIT_ACCOUNT;
...
DROP TABLE IF EXISTS DEPOSIT_RATIO;
...
(
	...
	LAST_UPDATED_AT timestamp(29),
	VER int,
	PRIMARY KEY (DEPOSIT_TYPE, VALID_START_DAY),
	UNIQUE (DEPOSIT_TYPE, VALID_START_DAY)
) WITHOUT OIDS;
...
(
	...
	UNIQUE (TRADE_ID, USER_ID, FINANCIAL_CODE, BRANCH_ID, ACCOUNT_NO, FIXED_ACCOUNT_NO)
) WITHOUT OIDS;
...
CREATE TABLE FOREIGN_CURRENCY_DEPOSIT_ACCOUNT
(
	USER_ID varchar(8) NOT NULL,
	FINANCIAL_CODE varchar(4) NOT NULL,
	BRANCH_ID varchar(6) NOT NULL,
...
(
	...
	UNIQUE (TRADE_ID, USER_ID, FINANCIAL_CODE, BRANCH_ID, ACCOUNT_NO, FUND_ACCOUNT_NO, FUND_ID)
) WITHOUT OIDS;
...
ALTER TABLE FOREIGN_CURRENCY_DEPOSIT
	...
	REFERENCES FOREIGN_CURRENCY_DEPOSIT_ACCOUNT (USER_ID, FINANCIAL_CODE, BRANCH_ID, ACCOUNT_NO, FOREIGN_CURRENCY_ACCOUNT_NO)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE FOREIGN_CURRENCY_DEPOSIT_ACCOUNT
	ADD FOREIGN KEY (USER_ID, FINANCIAL_CODE, BRANCH_ID, ACCOUNT_NO)
	REFERENCES SAVINGS_ACCOUNT (USER_ID, FINANCIAL_CODE, BRANCH_ID, ACCOUNT_NO)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
